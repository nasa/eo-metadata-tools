...
### Tests
Not all code requires tests. Code meant as example, documentation, or experimental in nature do not need to have matching tests. Code meant to be authoritative or operational, or to be linked against and used in other peoples projects must have tests. Notebooks do not require tests.
